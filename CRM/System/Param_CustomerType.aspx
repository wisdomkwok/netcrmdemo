...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '客户类别', name: 'CustomerType' }
                ],                
                dataAction: 'local', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                //checkbox:true,
                url: "../data/Param_CustomerType.ashx?Action=grid",
        ...
        function add() {
            f_openWindow("System/Param_CustomerType_add.aspx", "新增产品", 390, 200);
        }
        ...
        function edit() {
            ...
            if (row) {
                f_openWindow('System/Param_CustomerType_add.aspx?pid=' + row.id, "修改产品", 390, 200);
            } else {
        ...
        function del() {
            ...
            if (row) {
                if (confirm("删除后不能恢复，\n您确定要删除？")) {
                    $.ajax({
                        type: "POST",
                        url: "../data/Param_CustomerType.ashx", 
        ...
        function f_save(item, dialog) {
            ...
            if (issave) {
                ...
                $.ajax({
                    url: "../data/Param_CustomerType.ashx", type: "POST",
                    data: issave,
