    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                //checkbox:true,
                url: "../data/Param_CustomerLevel.ashx?Action=grid",
        ...
        function add() {
            f_openWindow("System/Param_CustomerLevel_add.aspx", "新增产品", 390, 200);
        }
        ...
        function edit() {
            ...
            if (row) {
                f_openWindow('System/Param_CustomerLevel_add.aspx?pid=' + row.id, "修改产品", 390, 200);
            } else {
        ...
        function del() {
            ...
            if (row) {
                if (confirm("删除后不能恢复，\n您确定要删除？")) {
                    $.ajax({
                        type: "POST",
                        url: "../data/Param_CustomerLevel.ashx", 
        ...
        function f_save(item, dialog) {
            ...
            if (issave) {
                ...
                $.ajax({
                    url: "../data/Param_CustomerLevel.ashx", type: "POST",
                    data: issave,
