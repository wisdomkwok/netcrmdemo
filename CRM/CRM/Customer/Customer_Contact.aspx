    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '所属公司', name: 'C_customername', width: 180,align:'left' },
        ...
        function view() {
            if (view_auth) {
                ...
                if (row) {
                    parent.jQuery.ligerDialog.open({ width: 770, height: 490, title: "客户详情", url: "CRM/Customer/Customer_info.aspx?cid=" + row.C_customerid, buttons: [{ text: '关闭', onclick: function (item, dialog) { dialog.close(); } }] });
                } else {
