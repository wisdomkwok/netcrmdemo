...
<head id="Head1" >
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../data/Param_Product.ashx", /* 注意后面的名字对应CS的方法名称 */
            ...
            <tr>
                ...
                <td   >
                    <div style="float:left; height: 20px;">
                        <input type="text" id="T_product" name="T_product" ltype="text"   ligerui="{width:180}" validate="{required:true}" />
                    </div>                    
                </td>
            </tr>
            </table>
