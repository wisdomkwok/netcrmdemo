...
namespace XHD.BLL
{
	...
	public partial class Param_City
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.Param_City GetModelByCache(int id)
		{
			...
			return (XHD.Model.Param_City)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.Param_City> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.Param_City> DataTableToList(DataTable dt)
		{
			List<XHD.Model.Param_City> modelList = new List<XHD.Model.Param_City>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XHD.Model.Param_City model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new XHD.Model.Param_City();
