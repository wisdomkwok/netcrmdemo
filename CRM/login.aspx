...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            delCookie("xhd_crm_show_wellcome")
            if (getCookie("xhd_crm_id") && getCookie("xhd_crm_id") != null)
                $("#T_uid").val(getCookie("xhd_crm_id"))
    ...
    <form id="form1" name="form1">
        <div style="width: 731px; margin-left: 50px; margin-top: 200px;">
            <table id="__01" width="732" height="388" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td rowspan="6">
                      <a href="http://www.yjyrj.com" target="_blank">    <img src="images/logo/xhd.png" width="234" alt="XHD crm"/></a></td>
                ...
                <tr>
                    <td colspan="5" width="163" height="29" class="auto-style1">v1.0.0.14</td>
