...
<head>
    ...
    <script type="text/javascript">
        ...
        function f_selectContact() {
            $.ligerDialog.open({
                title: '选择联系人', width: 550, height: 300, url: 'getcustomer.aspx', buttons: [
    ...
    <form id="form1">
        ...
        <table style="width: 600px; margin: 5px;" class="bodytable1">
            ...
            <tr>
                ...
                <td>
                    <input id="T_mobil" name="T_mobil" type="text" ltype="text" ligerui="{width:196}" validate="{required:true }" />
                </td>
            </tr>
            <tr>
                <td>
