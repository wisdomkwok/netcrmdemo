...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function remote() {
            var url = "../data/hr_employee.ashx?Action=Exist&emp_id=" + getCookie("UserID") + "&rnd=" + Math.random();
            return url;
        }
        ...
        function f_save() {
            if ($(form1).valid()) {
                var sendtxt = "&Action=PersonalUpdate&id=" + getCookie("UserID");
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="width: 130px">
                        <input type="text" id="T_tel" name="T_tel" ltype="text" ligerui="{width:180}" validate="{required:true,cellphone:true,messages:{required:'请输入手机号'}}" /></td>
                    <td>
                        <div align="right" style="width: 61px">
                            身份证：
                        </div>
