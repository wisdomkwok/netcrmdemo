...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '¸ÚÎ»Ãû³Æ', name: 'post_name', width: 120 },
                    { display: '²¿ÃÅÃû³Æ', name: 'depname', width: 120 },
                    { display: 'Ö°Îñ¼¶±ð', name: 'position_name', width: 120 },
                    { display: 'ÐÕÃû', name: 'emp_name', width: 120 },
                    { display: '±¸×¢', name: 'note', width: 120 },
                    {
                ...
                url: "../../../data/hr_post.ashx?Action=grid&isdel=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $.getJSON("../../../data/toolbar.ashx?Action=GetSys&mid=82&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
