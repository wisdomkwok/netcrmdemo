...
<head>
    ...
    <script type="text/javascript">
        ...
        function test(GridData) {
            ...
            var xmltext = "";
            xmltext += "<graph caption='员工客户新增统计'   decimalPrecision='0' formatNumberScale='0' baseFontSize='12' yAxisMinValue='0' yAxisMaxValue='1'  showValues='0'>";
            xmltext += "   <categories>";
            ...
            for (var i = 0; i < GridData.Rows.length; i++) {
                var m1 = typeof (GridData.Rows[i].m1) != 'number' ? 0.001 : GridData.Rows[i].m1;
