...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //布局
            $("#layout1").ligerLayout({ leftWidth: 190, rightWidth: 190, bottomHeight: 25, allowBottomResize: false, height: '100%', onHeightChanged: f_heightChanged, isRightCollapse: true });
        ...
        function getUser() {
            ...
            $.get("data/Base.ashx?Action=GetOnline&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
...
<body>
    <form id="form1">
        ...
        <div style="background: #d2e2f2; height: 74px; overflow: hidden;">
            <div style="height: 47px; margin: 0; padding: 0;">
                <div style="width: 278px; float: left;">
                    <a href="http://www.yjyrj.com" target="_blank">
                ...
                <div style="float: right; width: 220px; height: 47px; margin-right: 65px;">
                    ...
                    <div style="width: 100%; height: 22px; line-height: 22px; vertical-align: bottom;">
                        ...
                        <div id="Username" style="font-size: 12px; color: Red; padding-left: 18px; background: url(images/user.jpg) no-repeat left center; width: 55px; float: right;"></div>
        ...
        <div id="layout1" style="width: 100%">
            ...
            <div position="bottom">
                Copyright © 2013-2020 yjyrj.com All Rights Reserved
                <a href="http://www.yjyrj.com" target="_blank">小黄豆软件</a> QQ:250476029  v1.0.0.14            
            </div>
        </div>
    </form>
</body>
