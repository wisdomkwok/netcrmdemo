...
<head>
    ...
    function f_selecttype(id) {
        top.$.ligerDialog.open({
            zindex: 9003,
            title: '选择联系人', width: 600, height: 350, url: 'hr/GetMultEmp.aspx?emp_ids=' + $("receiver_val").val(), buttons: [
                { text: '确定', onclick: function (item, dialog) { f_selectContactOK(item, dialog, id) } },
    ...
    function f_selecttype1(id) {
        top.$.ligerDialog.open({
            zindex: 9003,
            title: '选择联系人', width: 600, height: 350, url: 'hr/GetMultEmp.aspx?emp_ids=' + $("CC_val").val(), buttons: [
                { text: '确定', onclick: function (item, dialog) { f_selectContactOK(item, dialog, id) } },
                { text: '取消', onclick: function (item, dialog) { dialog.close(); } }
            ]
        });
    ...
    function f_selecttype2(id) {
        top.$.ligerDialog.open({
            zindex: 9003,
            title: '选择联系人', width: 600, height: 350, url: 'hr/GetMultEmp.aspx?emp_ids=' + $("Blindpeople_val").val(), buttons: [
                { text: '确定', onclick: function (item, dialog) { f_selectContactOK(item, dialog, id) } },
                { text: '取消', onclick: function (item, dialog) { dialog.close(); } }
            ]
        });
    ...
    <form id="form1">
        <div style="position: relative; z-index: 9999">
            ...
            <table style="width: 650px" class="bodytable3">
                <tr>
                    <td>
                        <div style="width: 68px; text-align: right;">收件人：</div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <div style="width: 68px; text-align: right;">抄送：</div>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <div style="width: 68px; text-align: right;">暗送：</div>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <div style="width: 68px; text-align: right;">主题：</div>
                    </td>
                    <td>
