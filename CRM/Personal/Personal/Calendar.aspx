...
<body style="margin-top: -1px">
    ...
    <script src="../../js/xgcalendar/datepicker_lang_zh_CN.js" type="text/javascript"></script>
    <script src="../../js/xgcalendar/jquery.datepicker.js" type="text/javascript"></script>
    <%-- <script src="../../js/xgcalendar/Common.js" type="text/javascript"></script>
    <script src="../../js/xgcalendar/blackbird.js" type="text/javascript"></script>
    
    <script src="../../js/xgcalendar/jquery.alert.js" type="text/javascript"></script>
    <script src="../../js/xgcalendar/jquery.ifrmdailog.js" defer="defer" type="text/javascript"></script>--%>
