    ...
    <form id="form1">     
        <table align="left" border="0" cellpadding="3" cellspacing="1" style="width: 462px;">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="T_price" name="T_price" ltype='text' onchange="set_tomoney(this.value)" style="text-align:right" ligerui="{width:150,number:true}" validate="{required:true}" /></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
