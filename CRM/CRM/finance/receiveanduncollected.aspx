    ...
    <script type="text/javascript">
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                   { display: '序号', width: 50, render: function (rowData, rowindex, value, column, rowid, page, pagesize) { return (page - 1) * pagesize + rowindex + 1; } },
                    ...
                    { display: '客户', name: 'Customer_name', width: 260, align: 'center' },
        ...
        function toolbar() {
            $("#toolbar").ligerToolBar({
                items: [
                    { type: 'button', text: '查看订单',  icon: '../../images/folder-open.gif', disable: true, click: function () {  view();  } },
        ...
        function view() {
            ...
            if (row) {
                parent.jQuery.ligerDialog.open({
                    ...
                    height: 490,
                    title: "订单详情",
                    url: "CRM/Sale/order_add.aspx?orderid=" + row.id, buttons: [{ text: '关闭', onclick: function (item, dialog) { dialog.close(); } }]
                });
            } else {
