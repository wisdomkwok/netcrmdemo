    ...
    <script type="text/javascript">
        ...
        function initselect() {
            ...
            h = $('#T_department').ligerComboBox({
                ...
                treeLeafOnly: false,
                tree: {
                    url: '../../data/hr_department.ashx?Action=tree&auth=1&rnd=' + Math.random(),
                    idFieldName: 'id',
                    parentIDFieldName: 'pid',
                    checkbox: false
                },
                onSelected: function (newvalue, newtext, newid) {
                    $.get("../../data/hr_employee.ashx?Action=combo&auth=1&did=" + newvalue + "&rnd=" + Math.random(), function (data, textStatus) {
                        g.setData(eval(data));
                        g.selectValue(newid);
                    });
                }
    ...
    <form id="form1">
        <table style="width: 600px; margin: 5px;" class='bodytable1'>
            ...
            <tr id="tr_contact3">
                ...
                <td>
                    <input id="T_mobil" name="T_mobil" type="text" ltype="text"
                        ligerui="{width:196}" validate="{required:true}" /></td>
            </tr>
            <tr id="tr_contact4">
                <td>
